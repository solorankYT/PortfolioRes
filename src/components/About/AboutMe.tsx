...
function AboutMe(){
    return(
        ...
        <span className="text-highlight"> I enjoy working on creating interactive and user-friendly web applications, and I'm continuously learning to deliver better and more visually appealing projects. 
