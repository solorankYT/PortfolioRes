...
function AboutSection(){
    return(
      ...
      <Card className="background-color"style={{ width: '18rem' }}>
          <Card.Img style={{ width: '10em', margin: '0 auto' , padding: '10px'}} variant="top" src="./webdevelopment.svg" />
        <Card.Body>
          ...
          <Col md={4} className="d-flex justify-content-center">
          <Card className="background-color"style={{ width: '18rem' }}>
          <Card.Img style={{ width: '10em', margin: '0 auto' , padding: '10px'}} variant="top" src="./webdesign.svg" />
        <Card.Body>
          ...
          <Col md={4} className="d-flex justify-content-center">
          <Card className="background-color"style={{ width: '18rem' }}>
          <Card.Img style={{ width: '10em', margin: '0 auto' , padding: '10px'}} variant="top" src="./photography.svg" />
        <Card.Body>
